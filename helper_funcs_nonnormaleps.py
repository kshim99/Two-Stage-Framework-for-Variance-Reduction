...
def gen_base_data():
    ...
    n = len(x)
    error = np.random.exponential(error_var,n) # even with non-normal errors, CLT should still hold for large n and guarantee normal distribution of ATE estimates
