...
plot(train$ds, train_y, xlim = c(min(train$ds), max(test$ds)), ylim=c(min(c(control_y,treat_y))-1,max(c(control_y,treat_y))+1),type = 'l', col = 'black',ylab = "Mean Temperature",xlab ="Time")
title("Monthly mean temperature")
